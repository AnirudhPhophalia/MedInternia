...
export default function CaseCard({
  ...
  caseData: any;
  onOpenDiscussion?: (caseId: string) => void;
  onReadMore?: () => void;
  isExpanded?: boolean;
}) {
  ...
  useEffect(() => {
    ...
    setStarred(
      userId ? starredBy.some((id: any) => id.toString() === userId) : false,
    );
  }, [caseData, userId]);
    ...
    >
      <CardContent>
        ...
        <Typography
          color="#444"
          fontSize={16}
          sx={{ mb: images.length ? 1 : 2, mt: 0.5, fontWeight: 400 }}
        >
          {shortDesc}
        </Typography>
        {/* Images preview */}
