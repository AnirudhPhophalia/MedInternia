  ...
  return (
    <Box>
      <Typography
        variant="subtitle2"
        fontWeight={700}
        sx={{ mb: 2.5, color: "#fff", letterSpacing: "0.02em" }}
      >
        {title}
      </Typography>
      <Stack spacing={1.5}>
    ...
    >
      ...
      >
        <Box sx={{ maxWidth: 320 }}>
          ...
          <Typography
            variant="body2"
            sx={{ color: "rgba(255,255,255,0.65)", lineHeight: 1.8, mb: 3 }}
          >
            Your gateway to medical learning, peer collaboration, career
            opportunities, and live webinars.
          </Typography>
