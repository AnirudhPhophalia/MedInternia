    ...
    >
      ...
      >
        <FormControlLabel
          ...
          label={<Typography variant="body2">Any Experience</Typography>}
        />
        <FormControlLabel
          value="1"
          control={<Radio size="small" />}
          label={<Typography variant="body2">Entry Level (0-1 yrs)</Typography>}
        />
        <FormControlLabel
          value="3"
          control={<Radio size="small" />}
          label={<Typography variant="body2">Mid Level (1-3 yrs)</Typography>}
        />
        <FormControlLabel
          value="5"
          control={<Radio size="small" />}
          label={<Typography variant="body2">Senior Level (5+ yrs)</Typography>}
        />
      </RadioGroup>
        ...
        <FormControlLabel
          control={
            <Switch
              ...
              onChange={(e) => onVisaChange(e.target.checked)}
              color="primary"
            />
          }
