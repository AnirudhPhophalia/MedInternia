export const medicalGlossary: Record<string, string> = {
  ...
  murmur:
    "An unusual, 'whooshing' heart sound that may be innocent or may reflect disease or malformation.",
  bruit:
    "A sound, typically an abnormal one, heard through a stethoscope; a murmur.",
  crepitus:
    "A grating sound or sensation produced by friction between bone and cartilage or the fractured parts of a bone.",
  stridor:
    "A harsh or grating sound heard during breathing, caused by obstruction of the windpipe or larynx.",
  wheeze:
  ...
  rhinorrhea:
    "A condition where the nasal cavity is filled with a significant amount of mucus fluid (runny nose).",
  otorrhea: "A discharge from the ear.",
  exudate:
    "A mass of cells and fluid that has seeped out of blood vessels or an organ, especially in inflammation.",
  transudate:
    "A fluid that passes through a membrane, which filters out all the cells and much of the protein, yielding a watery solution.",
  purulent: "Consisting of, containing, or discharging pus.",
  erythematous: "Redness of the skin or mucous membranes.",
  macule:
    "A flat, distinct, discolored area of skin less than 1 centimeter wide.",
  papule:
  ...
  fissure:
    "A long, narrow opening or line of breakage made by cracking or splitting, especially in skin or rock.",
  excoriation:
    "A scratch mark; a linear break in the skin surface, usually covered with blood or serous crusts.",
  lichenification:
    "Thickening of the skin with accentuation of normal skin markings; it is a result of chronic scratching or rubbing.",
  ...
  spongiosis:
    "Intercellular edema (abnormal accumulation of fluid) in the epidermis.",
  apoptosis:
  ...
  malignant:
    "Very virulent or infectious; (of a tumor) tending to invade normal tissue or to recur after removal; cancerous.",
  ...
  zoonotic:
    "Relating to a disease that can be transmitted from animals to people.",
  "vector-borne":
  ...
  pulmonology:
    "The branch of medicine concerned with the anatomy, physiology, and pathology of the lungs.",
  gastroenterology:
  ...
  surgery:
    "The medical specialty that uses operative manual and instrumental techniques on a person to investigate or treat a pathological condition such as a disease or injury.",
  anesthesiology:
  ...
  ophthalmology:
    "The branch of medicine and surgery which deals with the diagnosis and treatment of eye disorders.",
};
