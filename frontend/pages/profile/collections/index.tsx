              ...
              <Grid size={{ xs: 12 }}>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mt: 1, mb: 3 }}
                  >
                    Find an interesting case on the platform and click the
                    "Save" button to start bookmarking!
                  </Typography>
                  <Button
                    variant="contained"
                    component={Link}
              ...
              collections.map((collection) => (
                <Grid size={{ xs: 12, sm: 6, md: 4 }} key={collection._id}>
                  <Card
                    ...
                    onClick={() =>
                      router.push(`/profile/collections/${collection._id}`)
                    }
                  >
                    <CardContent
                      sx={{
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {collection.cases.length} Saved{" "}
                        {collection.cases.length === 1 ? "Case" : "Cases"}
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
