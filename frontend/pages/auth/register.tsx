...
export default function Register() {
  ...
  // For progress bar
  const requiredFieldsStep1: (keyof typeof form)[] = [
    "firstName",
    "lastName",
    "email",
    "password",
  ...
  const handleMultiSelectChange = (
    ...
    const noneJustAdded =
      selected.includes("None") && !previous.includes("None");
  ...
  const handleSubmit = async (e: any) => {
    ...
    const emergencyPhoneValidationError = getOptionalPhoneError(
    ...
    if (
      ...
      form.phone === form.emergencyContactPhone
    ) {
    ...
    if (form.userType === "doctor") {
      ...
      let age =
        today.getFullYear() - (dob ? dob.getFullYear() : today.getFullYear());
      if (dob && age < 22) {
                          ...
                          endAdornment: (
                            <InputAdornment position="end">
                              <Button
                                ...
                                disabled={
                                  sendingOtp || emailVerified || !form.email
                                }
                                  ...
                                  <VisibilityOff
                                    sx={{
                                      transition:
                                        "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
                                      animation:
                                        "premiumRotateOut 0.25s cubic-bezier(0.4, 0, 0.2, 1) forwards",
                                  ...
                                  <Visibility
                                    sx={{
                                      transition:
                                        "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
                                      animation:
                                        "premiumRotateIn 0.25s cubic-bezier(0.4, 0, 0.2, 1) forwards",
                          ...
                          <Autocomplete
                            ...
                            value={
                              medicalColleges.find(
                                (college) =>
                                  college.name === form.medicalSchool,
                              ) || null
                            }
                            onChange={(_, value) =>
                              setForm({
                      ...
                      <Fade in timeout={600}>
                        ...
                        >
                          ...
                          >
                            <MenuItem value="None">
                              <Checkbox
                                checked={form.medicalHistory.includes("None")}
                              />
                          ...
                          >
                            <MenuItem value="None">
                              <Checkbox
                                checked={form.allergies.includes("None")}
                              />
                              <ListItemText primary="None" />
                            </MenuItem>
