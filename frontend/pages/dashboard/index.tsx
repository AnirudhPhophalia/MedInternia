...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const user =
          userRes.data?.data?.user || userRes.data?.user || userRes.data;
  ...
  const workspaceCards = [
    ...
    },
    {
      ...
      icon: <DashboardIcon sx={{ color: "#9c27b0" }} />,
    },
    {
      label: "Mentorship Hub",
      href: "/mentorship",
      icon: <People sx={{ color: "#00bcd4" }} />,
    },
    {
      label: "Peer Reviews",
      href: "/reviews",
      icon: <RateReview sx={{ color: "#ff9800" }} />,
    },
    {
      label: "Webinars",
      href: "/webinars",
      icon: <CalendarToday sx={{ color: "#4caf50" }} />,
    },
    {
      label: "Certificates",
      href: "/certificates",
    ...
    },
    {
      label: "Leaderboard",
      href: "/leaderboard",
      icon: <Leaderboard sx={{ color: "#ffeb3b" }} />,
    },
  ];
        ...
        >
          <Box>
            ...
            <Typography variant="body1" color="text.secondary" fontWeight={500}>
              {user.userType === "doctor" &&
                "Clinical Hub Mode: Review active cases, patient metrics, and pending peer reviews."}
              {user.userType === "intern" &&
                "Training Mode: Access your active clinical mentorship tracks and complete certificate modules."}
              {user.userType === "patient" &&
                "Patient Portal: Check health records, updates, and upcoming educational webinars."}
            </Typography>
          </Box>
          <Button
            variant="contained"
                      ...
                      {cases.length === 0 ? (
                        <Stack spacing={1.5}>
                          {[
                            {
                              title:
                                "Acute Myocardial Infarction Case Diagnosis Study",
                              status: "Completed",
                              date: "Today",
                              diff: "Advanced",
                            },
                            {
                              title:
                                "Pediatric Asthma Management Seminar Participation",
                              status: "Registered",
                              date: "Yesterday",
                              diff: "Intermediate",
                            },
                            {
                              title:
                                "Neurological Diagnostic Peer Assessment Protocol",
                              status: "In Review",
                              date: "2 days ago",
                              diff: "Expert",
                            },
                            ...
                            >
                              ...
                              >
                                <Box sx={{ display: "flex", gap: 1 }}>
                                  <Chip
                                    label={caseItem.difficulty || "Beginner"}
                                    size="small"
                                    sx={{
                                      fontWeight: 600,
                                      height: 18,
                                  ...
                                  />
                                  <Chip
                                    label={`${caseItem.likes?.length || 0} Interactions`}
                                    size="small"
                                    variant="outlined"
                                    sx={{
                                      fontWeight: 600,
                  ...
                  <Stack spacing={3} sx={{ height: "100%" }}>
                    ...
                    >
                      <CardContent sx={{ p: 2.5 }}>
                        ...
                        >
                          <CalendarToday
                            sx={{ mr: 1, color: "#16a34a", fontSize: 20 }}
                          />
                        ...
                        {webinars.length === 0 ? (
                          ...
                          >
                            <Typography
                              ...
                              color="#16a34a"
                            >
                              Interactive Cardiac Imaging Seminar
                            </Typography>
                            <Typography
                              variant="caption"
                              color="text.secondary"
                    ...
                    >
                      <CardContent sx={{ p: 2.5 }}>
                        ...
                        >
                          <NotificationsIcon
                            sx={{ mr: 1, color: "#ea580c", fontSize: 20 }}
                          />
                          <Typography variant="subtitle2" fontWeight={700}>
                            Notifications
                          </Typography>
                        ...
                        {notifications.length === 0 ? (
                          ...
                          >
                            <Typography
                              ...
                              display="block"
                            >
                              Your submitted diagnostic report was successfully
                              approved by the peer advisory team.
                            </Typography>
                          </Box>
                        ) : (
                          <Stack spacing={1}>
