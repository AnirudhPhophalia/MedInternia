        ...
        {flashcards.length === 0 ? (
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Click "Create Flashcard" on any case, or create one manually
              below.
            </Typography>
            <Button
              variant="contained"
                  ...
                  <CardContent sx={{ flex: 1, p: 3 }}>
                    ...
                    >
                      <Typography variant="caption" color="text.disabled">
                        {card.repetitions} review
                        {card.repetitions !== 1 ? "s" : ""} · Interval:{" "}
                        {card.interval}d
                      </Typography>
                    </Box>
                  </CardContent>
        ...
        >
          ...
          <DialogContent dividers>
            <TextField
              ...
              onChange={(e) =>
                setNewCard((p) => ({ ...p, question: e.target.value }))
              }
              placeholder="e.g., What is the classic triad of Cushing's syndrome?"
              sx={{ mb: 3 }}
            />
            <TextField
              fullWidth
              ...
              onChange={(e) =>
                setNewCard((p) => ({ ...p, answer: e.target.value }))
              }
              placeholder="e.g., Hypertension, Hyperglycemia, Central obesity"
              sx={{ mb: 3 }}
            />
            <TextField
              fullWidth
              ...
              value={newCard.tags}
              onChange={(e) =>
                setNewCard((p) => ({ ...p, tags: e.target.value }))
              }
          ...
          <DialogActions sx={{ p: 2 }}>
            ...
            <Button
              ...
              disabled={saving || !newCard.question || !newCard.answer}
            >
