...
const faqs = [
  {
    ...
    answer:
      "MedInternia is a comprehensive medical learning and collaboration platform designed for medical students, interns, doctors, and healthcare professionals. It provides access to clinical cases, educational webinars, internship opportunities, professional certificates, research papers, and peer collaboration tools to support continuous learning and career growth in the medical field.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You can track all your applications from your Dashboard under the 'My Applications' section. Here, you'll see the status of each application (Applied, Under Review, Shortlisted, Accepted, or Rejected). You'll also receive email notifications whenever there's an update to your application status, so you're always informed about your progress.",
  },
  {
    question: "Is there any application fee?",
    answer:
      "No, there is absolutely no application fee to register on MedInternia or apply for internships and opportunities. All job applications, course access, and platform features are completely free. We believe in providing equal access to medical education and career opportunities for all healthcare professionals.",
  },
  {
    question: "How do I contact support?",
    answer:
      "You can reach our support team in several ways: 1) Use the Contact page from the main menu to submit your query. 2) Email us at medinternia@gmail.com with details about your concern. 3) Check out our FAQ section for quick answers. 4) Use the in-app chat support during business hours. Our team typically responds within 24 hours.",
  },
  {
    question: "Are remote internships available?",
    answer:
      "Yes, MedInternia offers numerous remote internship opportunities. Remote internships are clearly marked in the job listing with a 'Remote' tag. These positions allow you to work from anywhere, making it perfect for students or professionals with scheduling flexibility. You can filter internships by location in the Jobs section to find remote opportunities.",
  },
];
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Typography
            ...
            fontWeight={900}
            color="#0072ff"
            sx={{ fontSize: { xs: "2.3rem", md: "3.5rem" }, mb: 2 }}
          >
            FAQs
          </Typography>
          ...
          {faqs.map((faq) => (
            ...
            >
              <AccordionSummary
                expandIcon={<ChevronDown size={20} color="#0072ff" />}
              >
