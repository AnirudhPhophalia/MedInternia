...
export default function AISuggestions() {
  ...
  const handleGetCaseSuggestions = async (caseId: string) => {
    ...
    try {
      ...
      setCaseSuggestions(
        res.data?.data?.suggestions || res.data?.suggestions || [],
      );
    } catch (e) {
      console.error(e);
  ...
  const getMatchScore = (c: any) => {
    ...
    if (
      c.specialization &&
      user.specialization &&
      c.specialization.toLowerCase() === user.specialization.toLowerCase()
    ) {
      score += 15;
    }
  ...
  const recommendedCases = allCases
    .filter(
      (c) =>
        c.specialization?.toLowerCase() === selectedSpecialty.toLowerCase(),
    )
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mb: 4, textAlign: "center" }}>
          ...
          <Typography
            ...
            sx={{ maxW: 600, mx: "auto" }}
          >
            Explore clinically relevant cases and medical content customized to
            your interests and specialization.
          </Typography>
        </Box>
          ...
          <Grid size={{ xs: 12, md: 7 }}>
            ...
            {recommendedCases.length === 0 ? (
              <Alert severity="info" sx={{ borderRadius: 3 }}>
                No cases found for {selectedSpecialty}. Try selecting another
                specialty to find learning material!
              </Alert>
            ) : (
              <Stack spacing={3}>
                      ...
                      >
                        <Box>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            Specialization: <strong>{c.specialization}</strong>{" "}
                            | Difficulty: <strong>{c.difficulty}</strong>
                          </Typography>
                        </Box>
                        <Chip
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  sx={{ mb: 3 }}
                >
                  Select an active case to retrieve its AI-matched similar cases
                  and expand your learning paths.
                </Typography>
                  ...
                  <Stack spacing={2}>
                    ...
                    {caseSuggestions.map((s) => (
                      ...
                      >
                        ...
                        <Typography variant="caption" color="text.secondary">
                          Specialty: {s.specialization} | Difficulty:{" "}
                          {s.difficulty}
                        </Typography>
                      </Box>
                    ))}
