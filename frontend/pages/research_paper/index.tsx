...
export default function ResearchPaperUpload() {
  ...
  const fields = [
    ...new Set(papers.map((paper) => paper.field).filter(Boolean)),
  ];

  const difficulties = [
    ...new Set(papers.map((paper) => paper.difficulty).filter(Boolean)),
  ];
  ...
  const filteredPapers = papers.filter((paper) => {
    ...
    const matchesField = !selectedField || paper.field === selectedField;

    const matchesDifficulty =
      !selectedDifficulty || paper.difficulty === selectedDifficulty;
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: 5 }}>
        ...
        <Typography variant="h6" color="#555" sx={{ fontWeight: 400, mb: 2 }}>
          Discover, review, and contribute to medical research papers. Share
          your findings and expand the knowledge base.
        </Typography>
        <Button
          disabled={isPatient}
          variant="contained"
      ...
      <Box sx={{ maxWidth: 800, mx: "auto", mb: 6 }}>
        {loading ? (
          ...
          >
            ...
            <Typography fontSize={15} color="#888">
              Be the first to share a research paper with the community!
            </Typography>
          </Box>
        ) : (
        ...
        <Dialog
          ...
          fullWidth
        >
          <DialogTitle fontWeight={800} color="#0056cc">
            {openPaper?.title}
          </DialogTitle>
          <DialogContent>
            <Typography
                ...
                startIcon={
                  <span style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      <path
                        fill="#0072ff"
                        d="M12 16.5a1 1 0 0 1-1-1V5a1 1 0 1 1 2 0v10.5a1 1 0 0 1-1 1Z"
                      />
                      <path
                        fill="#0072ff"
                        d="M7.21 13.79a1 1 0 0 1 1.42-1.42l2.29 2.3 2.29-2.3a1 1 0 1 1 1.42 1.42l-3 3a1 1 0 0 1-1.42 0l-3-3Z"
                      />
                      <path
                        fill="#0072ff"
        ...
        >
          ...
          <DialogContent>
            {openDiscussionId && (
              <ResearchPaperDiscussion id={openDiscussionId} modalMode />
            )}
          </DialogContent>
        </Dialog>
      </Box>
      ...
      >
        ...
        >
          ...
          >
            Share medical research papers, guides, and reference materials to
          ...
          {isPatient ? (
            <Alert severity="info" sx={{ mb: 2 }}>
              Patients cannot upload research papers. Please use the research
              library to view available papers.
            </Alert>
          ) : (
            <form
