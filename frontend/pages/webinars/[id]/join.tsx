...
export default function JoinWebinar() {
  ...
  const isHost =
    webinar?.host?._id === currentUserId || webinar?.host === currentUserId;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Chip
          label={webinar.status.toUpperCase()}
          color={webinar.status === "live" ? "error" : "default"}
        />
      </Box>
      ...
      >
        ...
        <Box
          sx={{ height: "100%", p: 2, width: { xs: "100%", md: "66.666%" } }}
        >
          <Box
            sx={{
              width: "100%",
        ...
        >
          ...
          >
            ...
            <CardContent sx={{ flex: 1, overflowY: "auto" }}>
              ...
              {webinar.polls && webinar.polls.length > 0 ? (
                webinar.polls
                  .map((poll: any) => {
                    const totalVotes = Object.keys(poll.votes || {}).length;
                    const userVoted =
                      poll.votes &&
                      typeof poll.votes === "object" &&
                      currentUserId in poll.votes;
                    const selectedOption = userVoted
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          mb: 3,
                          p: 2,
                          bgcolor: poll.active ? "#fff" : "#f9f9f9",
                      ...
                      >
                        ...
                        {poll.active && !userVoted && !isHost ? (
                          <FormControl component="fieldset">
                            <RadioGroup
                              onChange={(e) =>
                                handleVotePoll(poll._id, Number(e.target.value))
                              }
                            >
                          ...
                          <Box sx={{ mt: 1 }}>
                            {poll.options.map((opt: string, i: number) => {
                              ...
                              const percentage =
                                totalVotes > 0
                                  ? Math.round((votesForOpt / totalVotes) * 100)
                                  : 0;
                              return (
                                <Box key={i} sx={{ mb: 1 }}>
                                  <Box
          ...
          >
            ...
            >
              <Box sx={{ flex: 1, overflowY: "auto", mb: 2 }}>
                {webinar.qna && webinar.qna.length > 0 ? (
                  [...webinar.qna]
                    .sort(
                      (a, b) =>
                    ...
                    .map((q: any) => {
                      ...
                      const authorName = q.author?.firstName
                      ...
                      return (
                        ...
                        >
                          ...
                          <Box
                            sx={{
                              flex: 1,
                              bgcolor: q.isAnswered ? "#f0fdf4" : "#fff",
                              p: 1.5,
                              borderRadius: 2,
                              border: "1px solid #e0e0e0",
                            }}
