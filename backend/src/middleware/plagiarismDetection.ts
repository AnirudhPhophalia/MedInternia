 ...
 */
export const checkPlagiarismAndAI = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    console.log(
      "[Security Guardrail] Scanning submitted case for plagiarism and AI-generated content...",
    );
    ...
    if (isFlagged) {
      ...
      console.log(
        "[Security Guardrail] Scan complete. Content appears original.",
      );
    }
